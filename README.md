...
A Windows desktop application that audits your system's security configuration across 8 key areas, assigns a security score, and offers one-click automated fixes. Built as a dissertation project.
